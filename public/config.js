...
config.save = function()
{
    ...
    init.start();
    alert("Настройки сохранены"); //Заглушка объекта сохранения
    main.output();
};
...
//метод принятия изменений меню 
config.mainMenu.accept = function() {
    var len = config.mainMenu.editList.length;
    save.lsGroups.del("menu",config.mainMenu.editList);
